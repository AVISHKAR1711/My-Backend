...
const registerUser = asyncHandler( async(req,res) => {
 ...
 if(!createdUser){
    throw new ApiError(500,"Somethingwent went wrong while registering the user ")
 }
...
const changeCurrentPassword = asyncHandler(async(req,res) => {
 ...
 return res
 .status(200)
 .jason(new ApiResponse(200,{}, "Password Changed succefully"))
...
const updateAccountDetails = asyncHandler(async(req,res) => {
   ...
   const user = await  User.findByIdAndUpdate(
      ...
      {new : true}// return response after updation
    ).select("-password")
...
const updateUserAvatar = asyncHandler(async(req,res) => {
  ...
  return res
  .status(200)
  .json( new ApiResponse(200, user, " Avatar File uploading is successfuly"))
})
...
const updateUserCoverImage = asyncHandler(async(req,res) => {
  ...
  return res
  .status(200)
  .json( new ApiResponse(200, user," coverImage File uploading is successfuly"))
})
